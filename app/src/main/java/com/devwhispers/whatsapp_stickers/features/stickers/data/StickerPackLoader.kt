...
import com.devwhispers.whatsapp_stickers.StickerContentProvider.Companion.IMAGE_DATA_VERSION
import com.devwhispers.whatsapp_stickers.StickerContentProvider.Companion.IOS_APP_DOWNLOAD_LINK_IN_QUERY
import com.devwhispers.whatsapp_stickers.StickerContentProvider.Companion.LICENSE_AGREENMENT_WEBSITE
import com.devwhispers.whatsapp_stickers.StickerContentProvider.Companion.PRIVACY_POLICY_WEBSITE
import com.devwhispers.whatsapp_stickers.StickerContentProvider.Companion.PUBLISHER_EMAIL
import com.devwhispers.whatsapp_stickers.StickerContentProvider.Companion.PUBLISHER_WEBSITE
import com.devwhispers.whatsapp_stickers.StickerContentProvider.Companion.STICKER_FILE_EMOJI_IN_QUERY
import com.devwhispers.whatsapp_stickers.StickerContentProvider.Companion.STICKER_FILE_NAME_IN_QUERY
import com.devwhispers.whatsapp_stickers.StickerContentProvider.Companion.STICKER_PACK_ICON_IN_QUERY
        ...
        for (sticker in stickers) {
            ...
            try {
                bytes = fetchStickerAsset(
                    ...
                    sticker.imageFileName!!, context.contentResolver
                )
